...
import { ScrollView, Image, SubTitle, Google, Facebook, Title2, View, Text, Container, Title, Hamburger, TouchableOpacity, ImageBackground, Youtube}  from './styles'
...
function YoutubeTrendys( navigation ){
    ...
    return(
        ...
        <Container style={{flex:1,backgroundColor:'#16293E', }}>
            ...
            <View style={{flexDirection:'row', margin: 30, alignItems: 'center'}}>
                    <Youtube style={{marginRight: 10}}><Icon name="youtube" size={50} color="white" /></Youtube>
            ...
            >
                <Title style={{marginLeft: 30}}>Top Posts</Title>
                <Carousel 
                    data={lastNewsData}
