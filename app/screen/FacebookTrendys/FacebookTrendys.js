...
import { ScrollView, Image, SubTitle, Google, Facebook, Title2, View, Text, Container, Title, Hamburger, TouchableOpacity, ImageBackground}  from './styles'
    ...
    return(
        ...
        <Container style={{flex:1,backgroundColor:'#16293E', }}>
            ...
            <View style={{flexDirection:'row', margin: 30, alignItems: 'center'}}>
                    <Facebook style={{marginRight: 10}}><Icon name="facebook" size={50} color="white" /></Facebook>
