...
import { ScrollView, Image, SubTitle, Google, Facebook, Title2, View, Text, Container, Title, Hamburger, TouchableOpacity, ImageBackground, TikTok}  from './styles'
    ...
    return(
        ...
        <Container style={{flex:1,backgroundColor:'#16293E', }}>
            ...
            <View style={{flexDirection:'row', margin: 30, alignItems: 'center'}}>
                    <TikTok style={{marginRight: 10}}><Icon name="tiktok" size={50} color="white" /></TikTok>
                    <Title>TikTok</Title>
            </View>  
            ...
            >
                <Title style={{marginLeft: 30}}>On High</Title>
                <Carousel 
                    data={lastNewsData}
